...
public class TravelForum {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "travel_forum_seq_gen")
    @SequenceGenerator(name = "travel_forum_seq_gen", sequenceName = "TRAVEL_FORUM_SEQ", allocationSize = 1)
