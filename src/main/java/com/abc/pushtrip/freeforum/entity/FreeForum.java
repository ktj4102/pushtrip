...
@Entity
@Table(name = "FREE_FORUM")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class FreeForum {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "free_forum_seq_gen")
    @SequenceGenerator(name = "free_forum_seq_gen", sequenceName = "FREE_FORUM_SEQ", allocationSize = 1)
    @Column(name = "FREEID", nullable = false)
    private Long freeId;
